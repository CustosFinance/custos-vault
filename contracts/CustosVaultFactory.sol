...
contract CustosVaultFactory is Ownable, IFactory, IInstanceRegistry, ERC721 {
    ...
    constructor() ERC721("CustosVault", "CUSTOSVAULT") {
        ERC721._setBaseURI("https://api.custos.finance.co/nft/");
    }
    ...
    function create2(bytes calldata, bytes32 salt)
        external
        override
    ...
    function createSelected2(bytes32 name, bytes32 salt)
        public
        returns (address vault)
    {
        // create clone and initialize
    ...
    function getVault(address owner, uint256 index)
        public
        view
        returns (address)
    {
    ...
    function getAllVaults(address owner)
        public
        view
